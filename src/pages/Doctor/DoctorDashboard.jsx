...
function DoctorDashboard() {
    ...
    return (
        <div className="min-h-screen bg-background aurora-bg">
            ...
            <div className="relative bg-blue-500/10 px-3 sm:px-6 pt-6 sm:pt-8 pb-4 sm:pb-6 border-b soft-divider">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 sm:gap-6">
                    ...
                    <div className="flex items-center gap-3 sm:gap-4">
                        ...
                        <button className="relative rounded-xl sm:rounded-2xl px-3 sm:px-4 py-2 sm:py-3 text-white shadow-xl bg-blue-500 hover:bg-blue-600 transition-all">
                ...
                <div className="lg:col-span-8 space-y-6 sm:space-y-8">
                    ...
                    <div className="glass-elevated rounded-2xl sm:rounded-3xl p-4 sm:p-6 hover-glow-primary">
                        <h3 className="text-lg sm:text-xl font-bold text-text mb-4 sm:mb-6 flex items-center gap-3">
                            <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-blue-500 text-white flex items-center justify-center">
                        ...
                        <div className="flex md:grid md:grid-cols-3 gap-3 sm:gap-4 overflow-x-auto md:overflow-visible snap-x snap-mandatory pb-2 -mx-1 px-1">
                              ...
                              <button className="group rounded-xl sm:rounded-2xl p-4 sm:p-6 lift-on-hover hover-glow-accent transition-all border soft-divider bg-blue-500/10 snap-start min-w-[240px] md:min-w-0">
            ...
            <button
                onClick={() => setIsAIAssistantOpen(true)}
                className="fixed bottom-6 right-6 w-16 h-16 bg-blue-500 text-white rounded-full shadow-2xl hover:scale-110 transition-all duration-300 flex items-center justify-center z-40 lg:hidden"
